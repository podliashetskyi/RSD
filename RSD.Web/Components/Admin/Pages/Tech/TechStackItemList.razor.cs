...
public partial class TechStackItemList(ITechStackItemService Service, IToastService Toasts) : ComponentBase
{
    private List<TechStackItem> Items { get; set; } = [];
    ...
    private async Task ReloadAsync()
    {
        ...
        Items = list.OrderBy(t => t.DisplayOrder).ThenBy(t => t.Label).ToList();
    }
    ...
    {
        ApplyOutcome(await Service.SoftDeleteAsync(id, CancellationToken.None), "Item deleted.");
        await ReloadAsync();
    }
