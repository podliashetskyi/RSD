...
public partial class ServiceList(IServiceService Service, IToastService Toasts) : ComponentBase
{
    private List<RSD.Web.Data.Entities.Service> Items { get; set; } = [];
    ...
    private async Task DeleteAsync(Guid id)
    {
        ...
        if (result.Ok) Toasts.Show("Service deleted.", ToastKind.Success);
