...
public partial class BlogList(IBlogService Service, IToastService Toasts) : ComponentBase
{
    private List<BlogPost> Items { get; set; } = [];
    ...
    private async Task DeleteAsync(Guid id)
    {
        ...
        if (result.Ok) Toasts.Show("Post deleted.", ToastKind.Success);
