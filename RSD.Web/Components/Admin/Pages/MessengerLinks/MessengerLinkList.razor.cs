...
public partial class MessengerLinkList(IMessengerLinkService Service, IToastService Toasts) : ComponentBase
{
    private List<MessengerLink> Items { get; set; } = [];
    ...
    private async Task ReloadAsync()
    {
        ...
        Items = list.OrderBy(m => m.DisplayOrder).ThenBy(m => m.Label).ToList();
    }
