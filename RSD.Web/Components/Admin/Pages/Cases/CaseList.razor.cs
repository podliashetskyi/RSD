...
public partial class CaseList(ICaseService Service, IToastService Toasts) : ComponentBase
{
    private List<Case> Items { get; set; } = [];
    ...
    private async Task DeleteAsync(Guid id)
    {
        ...
        if (result.Ok) Toasts.Show("Case deleted.", ToastKind.Success);
