...
namespace RSD.Web.Data.Migrations
{
    ...
    [Migration("20260820083150_AddFaqShowOnHome")]
    partial class AddFaqShowOnHome
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RSD.Web.Data.Entities.FaqItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RSD.Web.Data.Entities.Filter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RSD.Web.Data.Entities.PrivacyPolicy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RSD.Web.Data.Entities.ProjectEstimate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<decimal>("EstimateMax")
                        .HasColumnType("numeric(12,2)");

                    b.Property<decimal>("EstimateMin")
                        .HasColumnType("numeric(12,2)");
                    ...
                    b.ToTable("project_estimates", (string)null);
                });
            ...
            modelBuilder.Entity("RSD.Web.Data.Entities.TermsOfService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.OwnsOne("RSD.Web.Data.Entities.SeoMetadata", "Seo", b1 =>
                        {
                            ...
                            b1.Property<string>("OgImageAlt")
                                .IsRequired()
                                .HasMaxLength(200)
                                .HasColumnType("character varying(200)")
                                .HasColumnName("SeoOgImageAlt");
            ...
            modelBuilder.Entity("RSD.Web.Data.Entities.PrivacyPolicy", b =>
                {
                    b.OwnsOne("RSD.Web.Data.Entities.SeoMetadata", "Seo", b1 =>
                        {
                            b1.Property<Guid>("PrivacyPolicyId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("PrivacyPolicyId");

                            b1.ToTable("privacy_policies");
            ...
            modelBuilder.Entity("RSD.Web.Data.Entities.TermsOfService", b =>
                {
                    b.OwnsOne("RSD.Web.Data.Entities.SeoMetadata", "Seo", b1 =>
                        {
                            b1.Property<Guid>("TermsOfServiceId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("TermsOfServiceId");

                            b1.ToTable("terms_of_service");
